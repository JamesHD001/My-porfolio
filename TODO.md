...
## Completed
- [x] Replace starter homepage with a professional portfolio layout.
- [x] Add responsive navigation and mobile menu.
- [x] Add hero, about, capabilities, projects, education, contact, and footer sections.
- [x] Add responsive CSS design system and reduced-motion support.
- [x] Add active-section navigation and dynamic copyright year.
- [x] Add links to selected GitHub projects.
- [x] Refine professional identity as Software Engineer, Graphic Designer, Writer & Composer.
- [x] Strengthen the About section with a clearer professional positioning and four-discipline breakdown.
